    ...
    <div class="container">
		<form class="form-horizontal" role="form" action="sign_up_check.php" onsubmit="return passFunction()" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<select name="discipline" class="form-control" id="discipline" placeholder="Select Discipline">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<select name="branch" class="form-control" id="branch" placeholder="Select Branch">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="yyyy" class="form-control" id="year" name="year" placeholder="yyyy">
				</div>
			</div>
